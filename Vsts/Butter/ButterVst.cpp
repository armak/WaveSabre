...
void ButterVst::getParameterName(VstInt32 index, char *text)
{
	...
	{
	case Butter::ParamIndices::Type: vst_strncpy(text, "Type", kVstMaxParamStrLen); break;
	case Butter::ParamIndices::Order: vst_strncpy(text, "Order", kVstMaxParamStrLen); break;
